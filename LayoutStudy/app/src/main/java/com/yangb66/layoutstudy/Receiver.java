...
//            manager.notify(times++, notify);
        ...
        else if(intent.getAction().equals(SETRECEIVEDYNAMIC)){  //动作检测
//            Goods good = (Goods)intent.getExtras().get("goods");
//            assert good != null;
//            int image = good.path;
//            Bitmap bm = BitmapFactory.decodeResource(context.getResources(), image);
